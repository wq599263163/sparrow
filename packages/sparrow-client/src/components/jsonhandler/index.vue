            ...
            var _pub_static = function() {
              ...
              var _init = function(oIni) {
                ...
                if (config.mode === 'request') {
                  ...
                  var getJsonStringRequest = jsonH_Request.create(
                    JH.request.NS.jsonH,
                    'getJsonString',
                    {
                      succeed: function(oResponseData, oRequestData) {
              ...
              _pri['startJsonH'] = function(sJson) {
                ...
                if (_pri.oIni) {
                  JH.e('#showValueInNav').checked =
                    _pri.oIni.showValue === undefined
                      ? true
                      : _pri.oIni.showValue;
                  ...
                  JH.e('#icoAsFolder').checked =
                    _pri.oIni.showStyle == 'folder';
